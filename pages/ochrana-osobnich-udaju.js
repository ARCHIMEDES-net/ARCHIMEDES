...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <h2>6. Google Tag Manager, Google Analytics a analytické cookies</h2>
      <p>
        Web používá Google Tag Manager jako technický nástroj pro správu
        měřicích značek. Samotné vložení Google Tag Manageru neznamená souhlas
        s analytickým ani marketingovým měřením. Výchozí nastavení analytických
        a reklamních úložišť je zakázané.
      </p>
      <p>
        Služba Google Analytics 4 poskytovaná společností Google Ireland Limited
        se aktivuje pouze po vašem výslovném souhlasu s analytickým měřením. Bez
        souhlasu se značka Google Analytics nenačte a analytické cookies se
        neuloží.
      </p>
      <p>
        Při aktivním souhlasu mohou být zpracovávány technické údaje o zařízení,
        navštívených stránkách, zdroji návštěvy a interakcích s webem. Souhlas
        můžete odmítnout bez omezení základních funkcí webu. Další informace o
        zpracování dat společností Google jsou uvedeny na{" "}
        <a
      ...
      <h2>7. Marketingové technologie</h2>
      <p>
        Marketingové a reklamní technologie, včetně případného Meta Pixelu,
        nejsou bez samostatného marketingového souhlasu aktivovány. Marketingový
        souhlas je oddělený od analytického souhlasu a jeho odmítnutí neomezuje
      ...
      <h2>10. Specifická role u škol a organizací</h2>
      <p>
      ...
      <h2>11. Kontaktní údaje</h2>
      <p>
        Dotazy k ochraně osobních údajů je možné směřovat na e-mail{" "}
