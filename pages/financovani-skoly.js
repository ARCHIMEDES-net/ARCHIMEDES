          ...
          <div className="mx-auto max-w-7xl px-5 py-14 sm:px-6 md:px-8 md:py-16">
            <div className="grid items-center gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
              <div>
                ...
                <h1 className="mt-6 max-w-3xl text-4xl font-black leading-[1.1] tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">
                  <span className="block">ARCHIMEDES Live</span>
                  <span className="block mt-2">přináší živý</span>
                  <span className="block mt-2">program do výuky.</span>
                </h1>
