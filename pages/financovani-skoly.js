          ...
          <div className="mx-auto max-w-7xl px-5 py-10 sm:px-6 md:px-8 md:py-16">
            ...
            <div className="grid items-center gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
              ...
              <div>
                ...
                {/* upravený hlavní nadpis */}

                <h1 className="mt-5 max-w-3xl text-4xl font-black leading-[1.1] tracking-tight text-slate-900 sm:text-5xl">
                  ARCHIMEDES Live
                  <br />
                  pro školy se Šablonami OP JAK
                </h1>
                ...
                <p className="mt-4 max-w-3xl text-base leading-7 text-slate-600 sm:text-lg">
                  ...
                  práci s žáky. Nejde o další složitou povinnost navíc,
                  ale o program, který můžete rovnou použít ve škole.
                </p>
