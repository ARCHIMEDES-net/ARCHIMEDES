    ...
    <RequireAuth>
      ...
      <div className="min-h-screen bg-slate-50">
        <div className="mx-auto max-w-[1180px] px-4 py-6">
          <Card className="mb-4 bg-gradient-to-b from-white to-blue-50/40 p-6">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="min-w-0 flex-[1_1_620px]">
                <SectionEyebrow>ARCHIMEDES Live • soutěže a projekty</SectionEyebrow>
              ...
              <div className="flex flex-wrap gap-2.5">
                <Button href="/portal/komunita" variant="secondary">
                  Komunita
                </Button>

                {isAdmin ? (
                  <Button href="/portal/admin-prispevky?section=contests">Přidat příspěvek</Button>
                ) : null}
              </div>
            </div>
          </Card>
          ...
          {loading ? <Alert variant="neutral">Načítám soutěže a projekty…</Alert> : null}
