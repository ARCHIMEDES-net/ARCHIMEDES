...
async function resolveAccessSetupState() {
  const {
    data: { user },
    error: userError,
...
export default function AccessSetupPage() {
  ...
  useEffect(() => {
    ...
    async function checkAccess() {
      try {
        const result = await resolveAccessSetupState();
            ...
            <>
              <Card className="mb-5 p-7">
                ...
                <p className="mb-2.5 max-w-[820px] text-[17px] leading-relaxed text-slate-700">
                  {organizations.length > 1
                    ...
                    : "Váš účet zatím není přiřazen k aktivní organizaci."}
                </p>
                ...
                <p className="max-w-[860px] text-[15px] leading-relaxed text-slate-500">
                  {organizations.length > 1
                    ...
                    : "Pokud jste učitel, připojte se školním kódem. V ostatních případech nás kontaktujte a přiřazení účtu ověříme."}
                </p>
              ...
              {organizations.length === 0 ? (
                ...
                <Card className="flex min-h-[220px] flex-col p-5">
                  ...
                  <p className="text-slate-600">
                    Pokud nejste učitel se školním kódem, napište nám. Ověříme
                    váš účet a správné přiřazení k organizaci.
                  </p>
                  <div className="mt-auto">
                    <Button href="/kontakt" className="mt-3.5">
                      Kontaktovat podporu
                    </Button>
                    <div className="mt-2.5 text-sm leading-relaxed text-slate-500">
