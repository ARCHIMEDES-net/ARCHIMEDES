        ...
        <form onSubmit={submit} style={{ background: "white", border: "1px solid rgba(0,0,0,0.10)", borderRadius: 16, padding: 16 }}>
          <div style={{ display: "grid", gap: 12, gridTemplateColumns: "1fr 1fr" }}>
            <label style={{ display: "grid", gap: 6 }}>
              ...
              <select value={form.type} onChange={(e) => set("type", e.target.value)} style={{ padding: 10, borderRadius: 12, border: "1px solid rgba(0,0,0,0.18)", background: "white" }}>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 14, flexWrap: "wrap" }}>
            <button type="submit" disabled={sending} style={{ padding: "10px 14px", borderRadius: 12, border: "1px solid rgba(0,0,0,0.18)", background: "black", color: "white", fontWeight: 900, cursor: sending ? "not-allowed" : "pointer" }}>
