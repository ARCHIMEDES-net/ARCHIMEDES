...
// Operational messages retain their read state and are shown only in administration.
export const CONTENT_NOTIFICATION_FILTER = "target_path.is.null,target_path.not.like./portal/admin%";
