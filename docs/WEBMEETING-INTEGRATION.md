...
- server ověří aktivní členství a efektivní licenci: vlastní aktivní program
  organizace nebo aktivní program její nadřazené obce;
...
1. aplikovat migraci `0013_webmeeting_integration_foundation.sql`;
