...
const broadcasts = [
  {
    src: "/pl7.webp",
    alt: "Tvořivá dílna pro první stupeň – valentýnské přání",
    category: "Tvoření · I. stupeň",
    title: "Valentýnské přání",
  },
  {
    src: "/pl53.jpg",
    alt: "Živé vysílání ze Zoo Praha o žirafách",
    category: "Příroda a ekologie",
    title: "Živě ze Zoo Praha",
  },
  {
    src: "/pl20.webp",
    alt: "Školní soutěž o Portugalsku a portugalských mořeplavcích",
    category: "Svět v souvislostech",
    title: "Portugalsko a mořeplavci",
  },
  {
    src: "/pl13.webp",
    alt: "Anglické vysílání s Paulem Wadem, ředitelem British Council",
    category: "Vysílání v angličtině",
    title: "Paul Wade · British Council",
  },
  {
    src: "/pl50.webp",
    alt: "Komiks od nápadu k pointě s ilustrátorkou Barborou Brůnovou",
    category: "Čtenářství a tvorba",
    title: "Komiks: od nápadu k pointě",
  },
];

export default function SchoolBroadcastGallery() {
  ...
  return (
    <section
      id="vysilali-jsme"
      aria-labelledby="skoly-vysilali-jsme-title"
      className="border-y border-slate-100 bg-white pb-16 pt-8 sm:pb-20 sm:pt-10"
    >
      <div className="mx-auto max-w-[1180px] px-5">
        <div className="max-w-3xl">
          <span className="text-xs font-black uppercase tracking-[0.16em] text-brand">
            Konkrétní program pro školy
          </span>
          <h2
            id="skoly-vysilali-jsme-title"
            className="mt-3 text-[clamp(34px,4vw,50px)] font-[950] leading-[1.03] tracking-[-0.045em] text-navy-900"
          >
            Vysílali jsme…
          </h2>
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-slate-600">
            Tvoření, příroda, svět kolem nás, angličtina i setkání s tvůrci.
            Konkrétní pořady, které učitel snadno propojí s výukou a žáci je
            mohou společně zažít přímo ve třídě.
          </p>
        </div>
