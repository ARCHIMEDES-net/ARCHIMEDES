...
const guardedRoutes = [
  ...
  ["admin/repair-profile-password-flag", () => import("../../pages/api/admin/repair-profile-password-flag"), "GET", "POST"],
  ["admin/repair-profile-full-name", () => import("../../pages/api/admin/repair-profile-full-name"), "GET", "POST"],
  ["admin/classify-shared-classroom-profile", () => import("../../pages/api/admin/classify-shared-classroom-profile"), "GET", "POST"],
  ["admin/mark-secondary-profile-no-email", () => import("../../pages/api/admin/mark-secondary-profile-no-email"), "GET", "POST"],
