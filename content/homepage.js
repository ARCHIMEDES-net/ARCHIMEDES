...
export const references = [
  {
    ...
    awardMeta: "Krajské kolo · 2026",
    awardTitle: "Zlatá stuha – Vesnice roku Jihomoravského kraje",
    description: "Čejč získala nejvyšší krajské ocenění a postoupila do celostátního kola.",
    crest: null,
    crestAlt: null,
    photo: "/cejc.jpg",
  ...
  },
  {
    ...
    awardMeta: "Celostátní vítěz · 2025",
    awardTitle: "1. místo v soutěži Obec 2030",
    description: "Nejvyšší ocenění získal Křenov za inovativní venkovní učebnu ARCHIMEDES® – komunitní prostor a chytrou učebnu v jednom.",
    crest: "/obec2030.jpeg",
  ...
  },
  {
    ...
    awardMeta: "Celostátní soutěž · 2023",
    awardTitle: "3. místo v soutěži NEJpraxe Zdravých měst, obcí a regionů",
    description: "Oceněnou dobrou praxí města byla Přírodní učebna ARCHIMEDES®.",
  ...
  },
  {
    ...
    awardMeta: "Krajské kolo · 2026",
    awardTitle: "Bílá stuha za práci s mládeží a podporu rodiny",
    description: "Ocenění v soutěži Vesnice roku za dlouhodobou spolupráci obce, škol a komunity.",
    crest: null,
    crestAlt: null,
  ...
  columns: [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Pro hosty", href: "/hoste" },
        { label: "For guests", href: "/guest" },
        { label: "Vysílali jsme", href: "/vysilali-jsme" },
